...
;; (add-to-list 'auto-mode-alist (cons (rx ".cs" eos) 'csharp-mode))
...
;; USAGE NOTES (Ewen Cheslack-Postava)
;; Add these to your .emacs file to get this mode working
;;
;; (autoload 'csharp-mode "csharp-mode" "Major mode for editing C# code." t)
;;
;; Add
;;         '("\\.cs$"        . csharp-mode)
;; to your auto-mode-alist
;;
;; And finally
;;
